...
check('package.json version must be 0.131.0 or later Batch133 compatible', ['0.131.0','0.132.0','0.133.0'].includes(pkg.version), pkg.version);
check('package-lock version must be 0.131.0 or later Batch133 compatible', ['0.131.0','0.132.0','0.133.0'].includes(lock.version), lock.version);
check('package-lock root version must be 0.131.0 or later Batch133 compatible', ['0.131.0','0.132.0','0.133.0'].includes(lock.packages?.['']?.version), lock.packages?.['']?.version);
...
check('policy must be Batch131', String(policy.batch || '').includes('Batch131'), policy.batch);
